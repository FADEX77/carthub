...
(41, 12, 5, 'Great irrigation system', 'This smart irrigation system has saved me so much time and water. The app is easy to use.', TRUE, 'approved'),
(42, 13, 4, 'Nice patio set', 'Good quality furniture set. The cushions are comfortable and it looks great on our deck.', TRUE, 'approved');

-- Update view counts and sales for better realism
UPDATE products SET view_count = FLOOR(RAND() * 1000) + 100, sales_count = FLOOR(RAND() * 50) + 5 WHERE id > 60;
